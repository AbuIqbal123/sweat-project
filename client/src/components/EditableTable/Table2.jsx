...
const MyTable2 = (props) => {
  ...
  const onSave = () => {
    ...
    if (!isWeightageValid) {
      toast.error('Weightage must be a number for all entries')
      return;
    }
    ...
    if (totalWeightage !== 100) {
      toast.error('The sum of weightages must be equal to 100')
      return;
    }
    toast.success('Assessments data successfully saved')
